...
import { retroScienceFictionBookCoverPrompt } from "./prompt";
...
export default function NeonGraffitiForm() {
  ...
  const handleGenerate = async () => {
    const defaultValues = {
      subject: t("retro_science_fiction_book_cover.defaultValue.subject"),
      color1: t("retro_science_fiction_book_cover.defaultValue.color1"),
      color2: t("retro_science_fiction_book_cover.defaultValue.color2"),
    };

    await generateImg({
      rawPrompt: `${subject || defaultValues.subject},${color1 || defaultValues.color1},${color2 || defaultValues.color2}`,
      prompt: retroScienceFictionBookCoverPrompt(
        subject || defaultValues.subject,
        color1 || defaultValues.color1,
        color2 || defaultValues.color2
      ),
      type: "retro_science_fiction_book_cover",
      size: "1024x1536",
      model,
    });
  };
      ...
      <div className="space-y-6">
        ...
        <div className="mt-4 flex items-center gap-4">
          <Label htmlFor="subject" className="w-20 flex-shrink-0">
            {t("retro_science_fiction_book_cover.label.subject")}
          </Label>
          <div className="flex w-full items-center space-x-3">
            <Input
              ...
              className="w-full"
              placeholder={t(
                "retro_science_fiction_book_cover.placeholder.subject"
              )}
            />
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="relative">
            <div className="flex items-center gap-4">
              <Label htmlFor="color1" className="w-20 flex-shrink-0">
          ...
          <div className="relative">
            <div className="flex items-center gap-4">
              <Label htmlFor="color2" className="w-20 flex-shrink-0">
