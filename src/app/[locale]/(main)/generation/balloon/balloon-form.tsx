...
import { balloonPrompt } from "./prompt";
...
export default function BalloonForm() {
  ...
  const handleGenerate = async () => {
    const defaultValues = {
      body: t("balloon.defaultValue.body"),
      backgroundColor: t("balloon.defaultValue.backgroundColor"),
    };

    await generateImg({
      rawPrompt: `${body || defaultValues.body},${backgroundColor || defaultValues.backgroundColor}`,
      prompt: balloonPrompt(
    ...
    <div className="mx-auto max-w-xl">
      <div className="space-y-6">
        ...
        <div className="mt-4 flex items-center gap-4">
          <Label htmlFor="body" className="w-20 flex-shrink-0">
            {t("balloon.label.body")}
          </Label>
          <div className="flex w-full items-center space-x-3">
            <Input
              ...
              className="w-full"
              placeholder={t("balloon.placeholder.body")}
            />
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center gap-4">
          <Label htmlFor="backgroundColor" className="w-20 flex-shrink-0">
            {t("balloon.label.backgroundColor")}
          </Label>
          <div className="flex w-full items-center space-x-3">
            <Input
              id="backgroundColor"
              ...
              className="w-full"
              placeholder={t("balloon.placeholder.backgroundColor")}
            />
            <div
